...
export class UploadValidator {
  ...
  constructor(options?: IUploadValidatorOptions) {
    this.fileType =
      options?.fileType ??
      /^image\/(jpg|jpeg|png|svg)$|application\/(pdf|msword|vnd.openxmlformats-officedocument.wordprocessingml.document|vnd.android.package-archive|doc|docx)$|audio\/(mp3|wav|ogg|x-m4a)$/i;
